function Chart(){
    ...
    me.setData = function(data){
        ...
        path.setAttribute('stroke', 'yellowgreen');
        ...
        for(let i=0; i < dataCount; i++){
            ...
            textTop.setAttribute('xmlns', 'http://www.w3.org/2000/svg'); 
            textTop.setAttribute('x',  barCenterX);
            textTop.setAttribute('y', barTop - 5);
            textTop.innerHTML = item.y;
            textTop.setAttribute('dominant-baseline', 'baseline');
            textTop.setAttribute('text-anchor', 'middle');
            textTop.setAttribute('font-size', 12);
            textTop.setAttribute('fill-opacity', 1);
            textTop.setAttribute('fill','black');
            me.svg.append(textTop);
        }
